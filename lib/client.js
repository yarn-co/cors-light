...
;(function(root) {
  ...
  // Called once on first action to create the iframe to the specified URI
  ...
  Client.prototype._handleResponse = function(event) {
    ...
    // otherwise it would have come back cl::badaction
    if (response.act == 'cl::badrequest') {
